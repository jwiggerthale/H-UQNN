...
class DenseDirichlet(nn.Module):
    ...
    def forward(self, x):
        ...
        return alpha, prob, aleatoric_uncertainty, epistemic_uncertainty
...
class ResNet18_32x32_EDL(nn.Module):
    def __init__(self, block=BasicBlock, num_blocks=None, num_classes=10):
        super(ResNet18_32x32_EDL, self).__init__()
        ...
        self.fc = Dirichlet(512 * block.expansion, num_classes)

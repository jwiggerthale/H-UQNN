...
from openood.postprocessors import (
    ...
    AdaScalePostprocessor, IODINPostprocessor, NCIPostprocessor, UQNNPostprocessor, EDLPostprocessor)
...
postprocessors = {
    ...
    'uqnn': UQNNPostprocessor,
    'edl': EDLPostprocessor
}
...
def get_postprocessor(config_root: str, postprocessor_name: str,
    ...
    print(link_prefix)
    print(f'{postprocessor_name}.yml')
